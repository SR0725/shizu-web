    ...
    data: {
        ...
        mainProjectlist: [
            ...
            },
            {
                ...
                text: `
                <div>
                綠Young森林的建築主體，為了能夠有效利用空間，而採用了圓弧曲線作為造型，同時添加了一份律動感。主要為公共空間，此處有著完善的小型生活圈，能夠在此做到生活的大部分需求，休閒育樂也能夠包辦。
                </div>
                `
            },
            {
                id: 2,
                title: "結構主義風格．在家就能欣賞藝術",
                text: `
                <div>
                居住空間的四棟建築，採用了結構主義風格，特殊的造型能夠有效的增加太陽光照射的面積，達到採光的效果，大小適中的居住空間，無論什麼類型的家庭皆能居住於此。
                </div>
                `
            },
            {
                ...
                text: `
                <div>
                上方的小球示意樹。平緩的坡道能夠悠閒地散步上三樓。另外，有著一定的斜度能方便排水避免積水，草地也能夠進一步的吸收雨水，減少因積水滑倒的危險性。
                </div>
                `
            },
            {
